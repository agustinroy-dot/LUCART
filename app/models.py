...
class AppSetting(db.Model):
    ...
    @staticmethod
    def get_all():
        # Performance Optimization: Request-level caching for AppSetting.
        # Fetches all settings in a single query and stores them in flask.g.
        # This prevents N+1 query issues where multiple AppSetting.get() calls
        # in a single request (e.g., quotes calculator) cause redundant DB queries.
        if has_app_context():
