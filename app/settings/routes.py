...
def export_data(type):
    def generate():
        ...
        if type == 'customers':
            ...
            records = Customer.query.yield_per(100)
            for r in records:
            ...
            # Using joinedload for many-to-one relationship is compatible with yield_per
            records = Order.query.options(joinedload(Order.customer)).yield_per(100)
            for r in records:
            ...
            records = Transaction.query.yield_per(100)
            for r in records:
            ...
            records = Material.query.yield_per(100)
            for r in records:
